...
export const CreateContactDTO = z.object({
  ...
  phone: z.string().min(7, "El teléfono debe tener al menos 7 dígitos").max(15, "El teléfono es demasiado largo").regex(/^\+?[\d\s-]+$/, "El teléfono contiene caracteres inválidos"),
